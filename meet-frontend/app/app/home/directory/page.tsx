            ...
            <div className="directory-sidebar">
                ...
                <div className="directory-sidebar-content">
                    {data.loaded && data.data?.["/directory"].data.map((user: any) => (
                        <DirectorySidebarItem key={user.id} name={user.name} subtitle={user.email} status={user.status}/>
                    ))}
                </div>
            </div>
        </div>
...
function DirectorySidebarItem({name, subtitle, status}: {name: string, subtitle: string, status: string}) {
    return (
        <div className="directory-sidebar-item">
